...
if __name__ == '__main__':
    ...
    while i < duration:
        ...
        ask_upbit, bid_upbit = current_prices_upbit('XRP/KRW')
        ...
        ask, bid = current_prices('XRP/USDT')
        ...
        np.save(f'xrp_orderbook1.npy', final)
        np.save(f'xrp_upbit_orderbook1.npy', final_upbit)
        np.save(f'xrp_time_binance.npy', time_binance)
        np.save(f'xrp_time_upbit.npy', time_upbit)